...
@section("title", "Prekių paieška")

@section("content")
    <div class="card">
        <div class="header">
            <h4 class="title">Prekių paieška</h4>
        </div>
        <form class="content" action="{{ route("products") }}" method="GET">
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group{{ $errors->has("product") ? " has-error" : "" }}">
                        <label for="product" class="form-control-label">Numeris</label>
                ...
                <div class="col-md-5 col-lg-4">
                    <div class="form-group{{ $errors->has("name") ? " has-error" : "" }}">
                        <label for="name" class="form-control-label">Pavadinimas</label>
